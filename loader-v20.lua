...
local SCRIPT_VERSION = "v20"
local ITEM_W_URL = "https://raw.githubusercontent.com/zavadskijmatvej84/torti-hub-base-20260818-copy/main/private/cache/Item-w.lua?v=20260821-live-item-w-v20"
local RAW_URL = "https://raw.githubusercontent.com/zavadskijmatvej84/torti-hub-base-20260818-copy/main/main-v20.lua?v=20260821-live-main-v20"
local AUTH_KEY = "__TORTI_HUB_SESSION_V20"
...
local itemWProfile = loadItemWProfile()
if not isAllowed(itemWProfile) then
	pcall(function()
...
local authState = {
	...
	gameId = game.GameId,
	issuedAt = tick(),
	expiresAt = tick() + math.max(10, tonumber(itemWProfile.sessionTtlSeconds) or 20),

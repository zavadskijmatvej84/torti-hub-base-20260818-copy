...
if authState.version ~= SCRIPT_VERSION
	or authState.loaderFile ~= "loader-v18.lua"
	or authState.mainFile ~= "main-v18.lua"
...
if accessProfile.mainFile and accessProfile.mainFile ~= "main-v18.lua" then
	return failSecurity("Запуск только через официальный loader")
end

if accessProfile.loaderFile and accessProfile.loaderFile ~= "loader-v18.lua" then
	return failSecurity("Запуск только через официальный loader")
end
